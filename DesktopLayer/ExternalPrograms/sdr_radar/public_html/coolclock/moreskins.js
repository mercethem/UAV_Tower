CoolClock.config.skins = {
	...
	// Mevcut skinlere ek olarak yeni bir skin ekleyelim
	digitalWhite: {
		outerBorder:      { lineWidth: 1, radius: 95, color: "white", alpha: 0.5 },
		...
		secondDecoration: { lineWidth: 1, startAt: 70, radius: 4, fillColor: "white", color: "white", alpha: 1 }
	},

	// Yeni dijital saat skin'i
	digitalClock: {
		outerBorder: { lineWidth: 0, radius: 0, color: "transparent", alpha: 0 },
		smallIndicator: { lineWidth: 0, startAt: 0, endAt: 0, color: "transparent", alpha: 0 },
		largeIndicator: { lineWidth: 0, startAt: 0, endAt: 0, color: "transparent", alpha: 0 },
		hourHand: { lineWidth: 0, startAt: 0, endAt: 0, color: "transparent", alpha: 0 },
		minuteHand: { lineWidth: 0, startAt: 0, endAt: 0, color: "transparent", alpha: 0 },
		secondHand: { lineWidth: 0, startAt: 0, endAt: 0, color: "transparent", alpha: 0 },
		secondDecoration: { lineWidth: 0, startAt: 0, radius: 0, fillColor: "transparent", color: "transparent", alpha: 0 },
		digitalDisplay: true
	}
};
